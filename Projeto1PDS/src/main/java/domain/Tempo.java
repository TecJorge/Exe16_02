...
/**
 * Representa um tempo atrav?s das horas, minutos e segundos.
 *
...
public class Tempo implements Comparable<Tempo> {
     ...
     * assumindo os segundos por omiss?o.
     *
     * @param horas   as horas do tempo.
     * @param minutos os minutos do tempo.
     */
    ...
    /**
     * Constr?i uma inst?ncia de Tempo recebendo as horas e assumindo os minutos
     * e os segundos, por omiss?o.
     *
     * @param horas as horas do tempo.
     */
    ...
    /**
     * Constr?i uma inst?ncia de Tempo com as horas, minutos e segundos, por
     * omiss?o.
     */
    public Tempo() {
    ...
    /**
     * Constr?i uma inst?ncia de Tempo com as mesmas carater?sticas do tempo
     * recebido por par?metro.
     *
     * @param outroTempo o tempo com as caracter?sticas a copiar.
     */
    ...
    /**
     * Devolve a descri??o textual do tempo no formato: %02d:%02d:%02d AM/PM.
     *
     * @return carater?sticas do tempo.
     */
    @Override
     ...
     *         tempo. Caso contr?rio, retorna false.
     */
    @Override
    ...
    /**
     * Compara o tempo com o outro tempo recebido por par?metro.
     * 
     * @param outroTempo o tempo a ser comparado.
     * @return o valor 0 se o outroTempo recebido ? igual ao tempo; o valor -1
    ...
    /**
     * Devolve true se o tempo for maior do que o tempo recebido por par?metro.
     * Se o tempo for menor ou igual ao tempo recebido por par?metro, devolve
     * false.
     *
     * @param outroTempo o outro tempo com o qual se compara o tempo.
     * @return true se o tempo for maior do que o tempo recebido por par?metro,
     ...
     * segundos) recebido por par?metro. Se o tempo for menor ou igual ao tempo
     * (horas, minutos e segundos) recebido por par?metro, devolve false.
     *
     ...
     *         segundos) recebido por par?metro, caso contr?rio devolve false.
     */
    ...
    /**
     * Devolve a diferen?a em segundos entre o tempo e o tempo recebido por
     * par?metro.
     *
     * @param outroTempo o outro tempo com o qual se compara o tempo para
     *                   calcular a diferen?a em segundos.
     * @return diferen?a em segundos entre o tempo e o tempo recebido por
     *         par?metro.
     */
    ...
    /**
     * Devolve uma inst?ncia Tempo representativa da diferen?a entre o tempo e
     * o tempo recebido por par?metro.
     *
     * @param outroTempo o outro tempo com o qual se compara o tempo para obter
     *                   uma inst?ncia Tempo representativa da diferen?a entre 
     *                   o tempo e o tempo recebido por par?metro.
     * @return inst?ncia Tempo representativa da diferen?a entre o tempo e o
     *         tempo recebido por par?metro.
     */
    ...
    public static Tempo tempoAtual() {
     ...
     /**
     * Devolve o n?mero de segundos correspondente ao tempo.
     *
     * @return n?mero de segundos correspondente ao tempo.
     */
