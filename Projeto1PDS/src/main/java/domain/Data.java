...
public class Data implements Comparable<Data> {
    ...
    private static final DiaDaSemana DIASemana_POR_OMISSAO = DiaDaSemana.DOMINGO;
    ...
    public static enum DiaDaSemana {
        ...
        TERCA {   @Override public String toString() { return "Terca-Feira"; } },
        ...
        SABADO {  @Override public String toString() { return "Sabado"; } };
     ...
     */
    public Data() {
        diaDaSemana=DIASemana_POR_OMISSAO;
    }
    ...
    public Data(Data outraData) {
        ...
        public Data(String diaDaSemana){
    ...
    public void setDiaDaSemana(String diaDaSemana) {
        ...
        for (DiaDaSemana aux:DiaDaSemana.values()) {
            if(diaDaSemana.equalsIgnoreCase(aux.toString())){
                existe=true;
            }
        } if (!existe){

        String[]arr=diaDaSemana.split("-");
        this.diaDaSemana = DiaDaSemana.valueOf(arr[0].toUpperCase(Locale.ROOT));
    }}
    ...
    public String DiaSemana(){
        return String.format("%s",diaDaSemana);
    }
