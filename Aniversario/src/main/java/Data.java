...
public class Data implements Comparable<Data> {
    ...
    private static enum Mes {
        ...
        */
         ...
         */
        public static Mes obterMes(int ordemDoMes)throws MesInvalidoException {
            if(ordemDoMes>12|| ordemDoMes==0)
                throw  new MesInvalidoException("Mes Inválido insira um mês contido entre 1 e 12 ");
    ...
    public Data(int ano, int mes, int dia) throws MesInvalidoException, DiaInvalidoException {
        ...
        if (dia>31 || dia==0 || dia!=this.mes.numeroDeDias(ano) )
            throw new DiaInvalidoException("Introduza um dia Valido contido entre 1 e 31");
        this.dia = dia;
    }
     ...
     */
    public final void setData(int ano, int mes, int dia) throws MesInvalidoException {
        this.ano = ano;         
        this.mes = Mes.obterMes(mes);       
        this.dia = dia;
    }
    ...
    public int compareTo(Data outraData) {
        int x=0;
        try {
            x=(outraData.isMaior(this)) ? -1 : (isMaior(outraData)) ? 1 : 0;
        } catch (MesInvalidoException e) {
            e.printStackTrace();
        }
        return x;}
     ...
     */
    public String diaDaSemana() throws MesInvalidoException {
     ...
     */
    public boolean isMaior(Data outraData) throws MesInvalidoException {
        int totalDias = contaDias();
     ...
     *         parâmetro.
     */
    public int diferenca(Data outraData) throws MesInvalidoException {
        int totalDias = contaDias();
        int totalDias1 = outraData.contaDias();
     ...
     */
    private int contaDias() throws MesInvalidoException {
        int totalDias = 0;
