...
public class Tempo implements Comparable<Tempo> {
    ...
    /**
     * Constrói uma inst?ncia de Tempo recebendo as horas, minutos e segundos.
     *
    ...
    /**
     * Constrói uma inst?ncia de Tempo recebendo as horas e os minutos e 
    ...
    /**
     * Constrói uma inst?ncia de Tempo recebendo as horas e assumindo os minutos
    ...
    /**
     * Constrói uma inst?ncia de Tempo com as horas, minutos e segundos, por
     * omiss?o.
     */
    public Tempo() {
    ...
    /**
     * Constrói uma inst?ncia de Tempo com as mesmas caraterísticas do tempo
     ...
     *         segundos) recebido por par?metro, caso contrário devolve false.
     */
    ...
    public Tempo diferencaEmTempoSemana(Tempo outroTempo) {
        int dif = diferencaEmSegundos(outroTempo)*5;
        int s = dif % 60;
        dif = dif / 60;
        int m = dif % 60;
        int h = dif / 60;
